  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>Dashboard Categorie</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>Vedi tutte le categorie</Text>
        </View>
      </View>
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text>{`Nessuna categoria trovata per ${filterItem}!`}</Text>
        ) : (
